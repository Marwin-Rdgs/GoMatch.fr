...
<div class="flex justify-center my-10">
    <div class="grid grid-cols-3 relative">
        <RouterLink to="/searchpetanque"> <arrowback class="w-32"/> </RouterLink>
        <foot />
        <RouterLink to="/searchbasket"><arrownext class="w-32"/> </RouterLink>
    </div>
</div>
...
methods:{
    async getterrain(){
        ...
        const dbterrain = collection(firestore, "terrainfoot");
  ...
  components: { pub, cardterrains, arrowback, arrownext, foot }
};
</script>